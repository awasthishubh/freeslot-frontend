...
import {all, members, requests, details, token, isLoggedIn} from './dashboard_reducer'
...
const rootReducer = combineReducers({
  ...
  orgAll:all, dashDetails:details, dashMembers:members, dashRequests: requests, orgToken:token, isLoggedIn
});
